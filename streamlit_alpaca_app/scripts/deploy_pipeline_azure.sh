...
DEPLOY_OUTPUTS_FILE="${ROOT_DIR}/infra/deployment.outputs.env"
...
KEYVAULT_NAME="${KEYVAULT_NAME:-${AZURE_KEY_VAULT_NAME:-snpipelinekv${SUFFIX}}}"
STORAGE_ACCOUNT="${STORAGE_ACCOUNT:-${STORAGE_ACCOUNT:-snpipeline${SUFFIX}}}"
ACR_NAME="${ACR_NAME:-${ACR_NAME:-snpipelineacr${SUFFIX}}}"
POSTGRES_SERVER="${POSTGRES_SERVER:-${POSTGRES_SERVER:-sn-pg-${SUFFIX}}}"
...
LOG_ANALYTICS="${LOG_ANALYTICS:-${LOG_ANALYTICS:-sn-pipeline-la-${SUFFIX}}}"
UAMI_NAME="${UAMI_NAME:-${MANAGED_IDENTITY:-sn-pipeline-mi-${SUFFIX}}}"
EXISTING_UAMI_RESOURCE_ID="${MANAGED_IDENTITY_RESOURCE_ID:-${MANAGED_IDENTITY_RESOURCE_ID:-${UAMI_RESOURCE_ID:-}}}"
...
MANAGED_IDENTITY_RESOURCE_ID=${UAMI_ID}
