...
for key in \
  ...
  STREAMLIT_MOBILE_UI_ENABLED STREAMLIT_LAYOUT_MODE_DEFAULT \
; do
...
STREAMLIT_MOBILE_UI_ENABLED="${STREAMLIT_MOBILE_UI_ENABLED:-}"
STREAMLIT_LAYOUT_MODE_DEFAULT="${STREAMLIT_LAYOUT_MODE_DEFAULT:-}"
...
obsolete_env = {
    "OMNIBAR_AGENT_LLM_API_KEY_SECRET_NAME",
    "OMNIBAR_AGENT_LLM_PROVIDER",
    "OMNIBAR_AGENT_LLM_MODEL",
    "OMNIBAR_AGENT_LLM_BASE_URL",
    "OMNIBAR_AGENT_LLM_TIMEOUT_SECONDS",
    "OMNIBAR_AGENT_LLM_REASONING_EFFORT",
    "OMNIBAR_AGENT_SYNTHESIS_LLM_MODEL",
    "OMNIBAR_AGENT_SYNTHESIS_LLM_DEPLOYMENT",
    "OMNIBAR_AGENT_SYNTHESIS_MODEL",
}
...
# Mobile web is a product runtime setting, not a one-off Azure edit. Keep it on
# for both dev and prod unless a deploy command explicitly opts out.
...
TARGET_STREAMLIT_MOBILE_UI_ENABLED_VALUE="$(existing_or_override_or_source_env "$TARGET_APP" "STREAMLIT_MOBILE_UI_ENABLED" "${STREAMLIT_MOBILE_UI_ENABLED:-}" "$PROMOTION_SOURCE_APP")"
TARGET_STREAMLIT_LAYOUT_MODE_DEFAULT_VALUE="$(existing_or_override_or_source_env "$TARGET_APP" "STREAMLIT_LAYOUT_MODE_DEFAULT" "${STREAMLIT_LAYOUT_MODE_DEFAULT:-}" "$PROMOTION_SOURCE_APP")"
...
maybe_append_env "STREAMLIT_MOBILE_UI_ENABLED" "$TARGET_STREAMLIT_MOBILE_UI_ENABLED_VALUE"
maybe_append_env "STREAMLIT_LAYOUT_MODE_DEFAULT" "$TARGET_STREAMLIT_LAYOUT_MODE_DEFAULT_VALUE"
