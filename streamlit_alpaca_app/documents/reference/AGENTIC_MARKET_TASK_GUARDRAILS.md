...
- Feature pages do not show job trigger controls. Job starts, retries, and refresh controls live in Admin > Pipeline Jobs.
...
- Trading Agent Build appears in Admin > Pipeline Jobs and produces all five required horizons: 1w, 1m, 3m, 1y, 5y.
