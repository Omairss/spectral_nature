"""
AQL Chat Log — durable persistence for omnibar agent sessions.
...
Storage layout:
  Postgres table: aql_chat_sessions (searchable index)
  Blob path:      aql/chat_logs/{date}/{run_id}.json (full payload)
"""
...
def log_chat_session(
    *,
    ...
    blob_path = f"aql/chat_logs/{date_slug}/{run_id}.json"
