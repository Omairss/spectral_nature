...
| Pipeline schedules | Cron expressions for all jobs | Job run cadence is fixed by explicit cron strings in env schedule file. | `infra/job_schedules.env` | `CONFIG` | Keep environment-managed and document as deployment contract. | P3 |
